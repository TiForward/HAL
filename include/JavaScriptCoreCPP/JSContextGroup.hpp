...
#undef  JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_TYPE
#define JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_TYPE std::recursive_mutex

#undef  JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME_PREFIX
#define JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME_PREFIX js_context_group

#undef  JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME
#define JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME_PREFIX##_mutex_

#undef  JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX
#define JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_TYPE JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME;

#undef  JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_LOCK_GUARD
#define JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_LOCK_GUARD std::lock_guard<JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_TYPE> JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME_PREFIX##_lock(JAVASCRIPTCORECPP_RAII_JSCONTEXTGROUP_MUTEX_NAME);
